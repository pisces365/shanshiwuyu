	...
	<view class="content">
		<scroll-view :scroll-top="scrollTop" scroll-y="true" class="scroll-Y" @scrolltoupper="upper"
			...
			<view class="main">
				...
				<view>
					<uni-list>
						<uni-list-item title="昵称" note=" " showArrow thumb="https://s1.ax1x.com/2022/03/30/qgKbtg.png"
							thumb-size="lg" rightText="设置" />
					</uni-list>
					<view class="" style="height: 100rpx;">
						
					</view>
					<uni-list>
						<uni-list-item title="个人信息" note=" " showArrow thumb="https://s1.ax1x.com/2022/03/30/qgMNHf.png"
							thumb-size="sm" rightText=" " />
						<uni-list-item title="偏好忌口" note=" " showArrow thumb="https://s1.ax1x.com/2022/03/30/qgMtDP.png"
							thumb-size="sm" rightText=" " />
							<uni-list-item title="健康记录" note=" " showArrow thumb="https://s1.ax1x.com/2022/03/30/qgMYut.png"
								thumb-size="sm" rightText=" " />
							<uni-list-item title="服药习惯" note=" " thumb="https://s1.ax1x.com/2022/03/30/qgMGjI.png"
								thumb-size="sm" rightText=" " :show-switch="true"/>
					</uni-list>
				</view>
	...
	export default {
		data() {
			return {
				scene: [{
						sign: '外卖',
						img: 'https://s1.ax1x.com/2022/03/30/qgiN7R.png'
					},
					{
						sign: '团购',
						img: 'https://s1.ax1x.com/2022/03/30/qgitB9.png'
					},
					{
						sign: '闪惠',
						img: 'https://s1.ax1x.com/2022/03/30/qgif4P.png'
					},
					{
						sign: '专属会员卡',
						img: 'https://s1.ax1x.com/2022/03/30/qgFsP0.png'
					},
				],
				dataList: [{
					id: "1",
...
<style>
	...
	.center {
		height: 510rpx;
		background-image: url(https://s4.ax1x.com/2022/02/16/HhTEtA.png);
	...
	.fuyaotixing {
		height: 300rpx;
		background-image: url(https://s4.ax1x.com/2022/02/16/HhT8ts.png);
		background-position: center 0;
		background-repeat: no-repeat;
	...
	.bar {
		...
		/* background-image: url(https://s1.ax1x.com/2022/03/29/q6Zkfx.png); */
		background-repeat: no-repeat;
